                  ...
                  <!-- Role Selection -->
                   <div class="mb-5">
                      <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                        I am a <span class="text-error-500">*</span>
                      </label>
                      <div class="flex gap-4">
                        <label class="flex items-center gap-2 cursor-pointer">
                          <input type="radio" v-model="role" value="pembeli" class="w-4 h-4 text-brand-500 focus:ring-brand-500" />
                          <span class="text-sm text-gray-700 dark:text-gray-400">Pembeli</span>
                        </label>
                        <label class="flex items-center gap-2 cursor-pointer">
                          <input type="radio" v-model="role" value="petani" class="w-4 h-4 text-brand-500 focus:ring-brand-500" />
                          <span class="text-sm text-gray-700 dark:text-gray-400">Petani</span>
                        </label>
                      </div>
                  </div>
                  <!-- Checkbox -->
...
const email = ref('')
const password = ref('')
const role = ref('pembeli') // Default role
